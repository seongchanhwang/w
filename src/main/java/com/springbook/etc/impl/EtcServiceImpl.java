...
public class EtcServiceImpl implements EtcService {
	...
	@Override
	public List<Map> selectAllThickness(String name) {
		// TODO Auto-generated method stub
		return etcMapper.selectAllThickness(name);
	}

	@Override
	public List<Map> selectAllSize(String name) {
		// TODO Auto-generated method stub
		return etcMapper.selectAllSize(name);
	}
